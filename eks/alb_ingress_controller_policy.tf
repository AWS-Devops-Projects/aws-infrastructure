...
data "aws_iam_policy_document" "eks_alb_ingress_controller_assume_role_policy" {
  statement {
...
resource "aws_iam_role" "ekscluster-alb-ingress-controller" {
  assume_role_policy = data.aws_iam_policy_document.eks_alb_ingress_controller_assume_role_policy.json
  name               = "${var.cluster_name}-alb-ingress-controller"
}

## Attach policy 
resource "aws_iam_role_policy_attachment" "ekscluster-alb-ingress-controller" {
  role       = aws_iam_role.ekscluster-alb-ingress-controller.name
